            ...
            children: [
              _objectMargin(
                InfoField(
                  ...
                  titleWidth: 90,
                  enabled: false,
                  value: (state.userProfile.customer?.username ?? "--").replaceAllMapped(
              ...
              _objectMargin(
                InfoField(
                  ...
                  titleWidth: 90,
                  enabled: false,
                  value: state.userProfile.customer?.email ?? "--",
                ),
              ),
              _objectMargin(
                InfoField(
                  ...
                  titleWidth: 90,
                  enabled: false,
                  value: state.userProfile.customer?.nickName ?? "--",
                ),
              ),
              _objectMargin(
                InfoField(
                  ...
                  titleWidth: 90,
                  enabled: false,
                  value: state.userProfile.customer?.recommandCode ?? "--",
                ),
              ),
              _objectMargin(
                InfoField(
                  ...
                  titleWidth: 90,
                  enabled: false,
                  value: state.userProfile.customer?.mbti ?? "--",
                ),
              ),
              _objectMargin(
                InfoField(
                  ...
                  titleWidth: 90,
                  enabled: false,
                  value: state.userProfile.customer?.loveType ?? "--",
                ),
              ),
              _objectMargin(
                InfoField(
                  ...
                  titleWidth: 90,
                  enabled: false,
                  value: state.userProfile.customer?.name ?? "--",
                ),
              ),
              _objectMargin(
                InfoField(
              ...
              _objectMargin(
                InfoField(
                  ...
                  titleWidth: 90,
                  enabled: false,
                  value: "${state.userProfile.profile?.myHeight ?? "--"}cm",
                ),
              ),
              _objectMargin(
                InfoField(
              ...
              _verifiedObjectMargin(
                  InfoField(
                    ...
                    enabled: false,
                    value:
                        "${state.userProfile.profile?.myAcademic != null ? "${(state.userProfile.profile?.myAcademic as AcademicType).title}" : "--"}/${state.userProfile.profile?.mySchoolName ?? "--"}",
                  ),
              ...
              _verifiedObjectMargin(
                  InfoField(
                    ...
                    enabled: false,
                    value:
                        "${state.userProfile.profile?.myJob != null ? (state.userProfile.profile?.myJob as JobType).title : "--"}",
                  ),
              ...
              _verifiedObjectMargin(
                  InfoField(
                    ...
                    enabled: false,
                    value:
                        "${state.userProfile.profile?.myMarriage != null ? (state.userProfile.profile?.myMarriage as MarriageType).title : "--"}",
                  ),
              ...
              _objectMargin(
                InfoField(
                  ...
                  enabled: false,
                  value:
                      "${state.userProfile.profile?.myChildren != null ? (state.userProfile.profile?.myChildren as HasChildrenType).title : "--"} ${state.userProfile.profile?.myChildren != null ? "${(state.userProfile.profile?.myChildrenMan ?? 0) == 0 ? "" : "${state.userProfile.profile?.myChildrenMan}남"} ${(state.userProfile.profile?.myChildrenWoman ?? 0) == 0 ? "" : "${state.userProfile.profile?.myChildrenWoman}녀"}" : ""}",
                ),
              ),
              SizedBox(height: 24),
              _objectMargin(
                InfoField(
                  ...
                  titleWidth: 90,
                  enabled: false,
                  value: "${state.userProfile.profile?.myReligion ?? "--"}",
                ),
              ),
              _objectMargin(
                InfoField(
                  ...
                  titleWidth: 90,
                  enabled: false,
                  value: "${state.userProfile.profile?.myParents ?? "--"}",
                ),
              ),
              _objectMargin(
                InfoField(
              ...
              _objectMargin(
                InfoField(
                  ...
                  titleWidth: 90,
                  enabled: false,
                  value: "${state.userProfile.profile?.myBloodType ?? "--"}",
                ),
              ),
              _objectMargin(
                InfoField(
