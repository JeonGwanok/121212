...
class RegisterPartnerInfoState extends Equatable {
  ...
  RegisterPartnerInfoState copyWith({
    ScreenStatus? status,
    UserProfile? user,
    List<City>? cities,
    bool? children,
    ...
    return RegisterPartnerInfoState(
